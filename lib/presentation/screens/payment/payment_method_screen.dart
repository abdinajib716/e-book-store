...
class _PaymentMethodScreenState extends State<PaymentMethodScreen> {
  ...
  void _showPhoneNumberInput(
      BuildContext context, Map<String, dynamic> method, double amount) {
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: _buildPaymentCard(method, widget.totalAmount, index),
          );
        },
      ),
    );
  ...
  Widget _buildPaymentCard(
      Map<String, dynamic> method, double amount, int index) {
