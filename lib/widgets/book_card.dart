...
class BookCard extends StatelessWidget {
        ...
        builder: (context, wishlist, _) {
          ...
          return Container(
            ...
            child: IconButton(
              ...
              onPressed: () => _handleWishlistToggle(context, wishlist, isInWishlist),
            ),
          );
        },
      ),
  ...
  void _handleWishlistToggle(BuildContext context, WishlistProvider wishlist, bool isInWishlist) {
    wishlist.toggleWishlist(book);
    final message = isInWishlist
        ? '${book.title} removed from wishlist'
        : '${book.title} added to wishlist';
    _showToast(message, isInWishlist ? AppStyles.errorColor : AppStyles.successColor);
  }

  void _handleCartAction(BuildContext context, CartProvider cart, bool isInCart) {
    if (!isInCart) {
      cart.addItem(book);
